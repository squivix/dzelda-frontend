...
import CourseEditPage from "@/views/CourseEditPage.vue";
...
import SignOutPage from "@/views/auth/SignOutPage.vue";
import {RouteRecordRaw} from "vue-router";
import ConfirmEmailPage from "@/views/auth/ConfirmEmailPage.vue";
